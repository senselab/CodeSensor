...
echo '  if ( fname.indexOf(".cpp") != -1 ) {';
echo '      h.value = "cpp";';
echo '  }';
echo '	else if ( fname.indexOf(".js") != -1) {';
echo '			h.value = "js";';
echo '  }';
...
//	echo '<option value="cpp11">C++11 (experimental)</option>';
    ...
    echo '<option value="java" selected>Java</option>';
